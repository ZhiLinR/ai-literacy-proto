...
from .calendly import CalendlyEvent

SUMMARISE_AND_EMAIL = {
        "type": "function",
        "name": "get_summary_and_email",
        "description": "This function is to prepare a concise summary for your firm. This function is to be used after the user has confirmed that they have made an appointment.",
        "parameters": {
            "type": "object",
            "properties": {
                "summary": {
...
class MailgunEmail(BaseModel):
    ...
    """
    def send_simple_message(self, chat_log: list, calendly_url: CalendlyEvent):
